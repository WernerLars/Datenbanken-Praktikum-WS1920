...
public class ViewProfileSupportedProjects{
	...
	public ViewProfileSupportedProjects() {
		
	}
	
	public ViewProfileSupportedProjects(String i,int k, String t,BigDecimal f,String st,BigDecimal sp) {
		this.Icon = i;
		this.Kennung = k;
		this.Titel = t;
